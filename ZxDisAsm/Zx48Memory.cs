...
namespace ZxDisAsm
{
    partial class Zx48Machine : Z80Core
    {
        ...
        const ushort ROMEnd   = 0x3FFF;
        const ushort ROMSize  = 0x4000;

        //byte[] ROM = new byte[ROMSize];

        /*оригинальный ROM Spectrum 48*/
        public byte[] ROM ={0xF3,0xAF,0x11,0xFF,0xFF,0xC3,0xCB,0x11,0x2A,0x5D,0x5C,0x22,0x5F,0x5C,0x18,0x43,
